/*
 * FD_CLUST_SCENARIOS — store clustering scenarios (Geographic / Behavioral / DC).
 * Ported verbatim from the legacy fd-assortment-v4-2.html seed data.
 *
 * Store Hub uses scenario "B" (Behavioral, the recommended one) to locate which
 * cluster a store belongs to and benchmark it against its peers. The full set is
 * exported here for reuse by the upcoming Location Clustering admin view.
 */
export const FD_CLUST_SCENARIOS = {
  A: {
    id: "A",
    name: "Scenario A — Geographic (current state)",
    badge: "Current",
    composite: 74,
    statScore: 71,
    bizScore: 76,
  ...
  C: {
    id: "C",
    name: "Scenario C — DC-based Operational",
    badge: "Operational",
    composite: 79,
    statScore: 82,
    bizScore: 76,
